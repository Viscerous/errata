...
export const PROVIDER_PRESETS = {
  deepseek: {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'blue', customHeaders: {},
  },
  openai: {
    name: 'OpenAI', baseURL: 'https://api.openai.com/v1', defaultModel: 'gpt-5.2',
    description: 'OpenAI models through the native API.',
    kind: 'cloud', requiresApiKey: true, accent: 'emerald', customHeaders: {},
  },
  anthropic: {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'amber', customHeaders: {},
  },
  gemini: {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'indigo', customHeaders: {},
  },
  kimi: {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'cyan', customHeaders: {},
  },
  'kimi-code': {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'rose', customHeaders: { 'User-Agent': 'claude-code/1.0' },
  },
  openrouter: {
    ...
    kind: 'cloud', requiresApiKey: true, accent: 'purple', customHeaders: {},
  },
  zai: {

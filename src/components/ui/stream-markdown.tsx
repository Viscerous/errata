...
const variantStyles: Record<StreamMarkdownVariant, {
  ...
  default: {
    ...
    li: 'mb-0.5',
    codeBlock: 'block bg-muted/50 rounded px-2 py-1.5 my-1.5 text-ui-label font-mono overflow-x-auto whitespace-pre',
    codeInline: 'bg-muted/50 rounded px-1 py-0.5 text-ui-label font-mono',
    ...
    table: 'w-full min-w-max border-collapse text-ui-label',
  ...
  prose: {
    ...
    li: 'mb-1 pl-0.5',
    codeBlock: 'block bg-muted/40 rounded-md px-3 py-2 my-3 text-ui-caption font-mono overflow-x-auto whitespace-pre leading-relaxed',
    codeInline: 'bg-muted/40 rounded px-1.5 py-0.5 text-ui-caption font-mono',

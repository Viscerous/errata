          ...
          {stickyFragments.map((fragment, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-ui-caption font-medium truncate leading-tight">{fragment.name}</p>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="text-ui-label font-mono text-muted-foreground">
                    {fragment.id}
                  </span>
                  <Badge
                    variant="outline"
                    className={cn(
                      'text-ui-label h-4 px-1',
                  ...
                  {fragment.placement === 'system' && (
                    <Badge variant="outline" className="text-ui-label h-4 px-1 text-muted-foreground bg-muted/30 border-transparent">
                      sys
                    </Badge>
                  )}
                </div>

...
export function ProseViewToolbar({
  ...
  return (
    <div className={cn(
      'absolute right-3 top-3 z-20 flex items-center gap-1.5 md:right-0',
      ...
      {hasOutline && (
        <>
          <Button
            ...
            className="size-9 border border-border/50 bg-elevated/90 shadow-sm backdrop-blur-md md:hidden"
          >
